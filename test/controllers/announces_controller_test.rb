...
class AnnouncesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announce" do
    assert_difference('Announce.count') do
      post announces_url, params: { announce: { message: @announce.message, title: @announce.title } }
    end
  ...
  test "should update announce" do
    patch announce_url(@announce), params: { announce: { message: @announce.message, title: @announce.title } }
